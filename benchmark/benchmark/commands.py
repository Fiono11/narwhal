...
class CommandMaker:
    ...
    @staticmethod
    def run_client(address, size, rate, nodes, id):
        ...
        return f'/Users/ruimorais/Desktop/DelegatedRingCT/target/release/benchmark_client {address} --size {size} --rate {rate} {nodes} --id {id}'
